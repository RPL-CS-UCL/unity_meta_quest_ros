...
"""autogenerated by genpy from unity_meta_quest_msgs/PositionServiceRequest.msg. Do not edit."""
import codecs
import sys
...
import unity_meta_quest_msgs.msg

class PositionServiceRequest(genpy.Message):
  _md5sum = "8e1dd27b40d577e01a5f9128d82cf0d0"
  _type = "unity_meta_quest_msgs/PositionServiceRequest"
...
string name"""
  __slots__ = ['input']
  _slot_types = ['unity_meta_quest_msgs/PosRot']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.input is None:
        self.input = unity_meta_quest_msgs.msg.PosRot()
    else:
      self.input = unity_meta_quest_msgs.msg.PosRot()
...
def _get_struct_7f():
    ...
    return _struct_7f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from unity_meta_quest_msgs/PositionServiceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class PositionServiceResponse(genpy.Message):
  _md5sum = "aabb3c03575b6efd312478691e8e83dc"
  _type = "unity_meta_quest_msgs/PositionServiceResponse"
  _has_header = False  # flag to mark the presence of a Header object
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.output is None:
        self.output = unity_meta_quest_msgs.msg.PosRot()
    else:
      self.output = unity_meta_quest_msgs.msg.PosRot()
...
class PositionService(object):
  _type          = 'unity_meta_quest_msgs/PositionService'
  _md5sum = '74d162dfa312ad5f1087485ee56d06ee'
