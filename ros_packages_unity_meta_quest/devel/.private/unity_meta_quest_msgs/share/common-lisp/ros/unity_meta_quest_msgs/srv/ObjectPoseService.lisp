...
(cl:defmethod cl:initialize-instance :after ((m <ObjectPoseService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectPoseService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unity_meta_quest_msgs-srv:<ObjectPoseService-request> is deprecated: use unity_meta_quest_msgs-srv:ObjectPoseService-request instead.")))

(cl:ensure-generic-function 'object_name-val :lambda-list '(m))
(cl:defmethod object_name-val ((m <ObjectPoseService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_meta_quest_msgs-srv:object_name-val is deprecated.  Use unity_meta_quest_msgs-srv:object_name instead.")
  (object_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObjectPoseService-request>)))
  ...
  "unity_meta_quest_msgs/ObjectPoseServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectPoseService-request)))
  "Returns string type for a service object of type 'ObjectPoseService-request"
  "unity_meta_quest_msgs/ObjectPoseServiceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectPoseService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectPoseService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unity_meta_quest_msgs-srv:<ObjectPoseService-response> is deprecated: use unity_meta_quest_msgs-srv:ObjectPoseService-response instead.")))

(cl:ensure-generic-function 'object_pose-val :lambda-list '(m))
(cl:defmethod object_pose-val ((m <ObjectPoseService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_meta_quest_msgs-srv:object_pose-val is deprecated.  Use unity_meta_quest_msgs-srv:object_pose instead.")
  (object_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObjectPoseService-response>)))
  ...
  "unity_meta_quest_msgs/ObjectPoseServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectPoseService-response)))
  "Returns string type for a service object of type 'ObjectPoseService-response"
  "unity_meta_quest_msgs/ObjectPoseServiceResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectPoseService)))
  ...
  "unity_meta_quest_msgs/ObjectPoseService")