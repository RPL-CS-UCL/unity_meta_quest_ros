...
class FrankaImagePublisher:
    def __init__(self, robot_ip, filename):
        ...
        # camera is 30Hz, divide by this number to set image publish rate
        #self.count = 5
    ...
    def capture_and_publish_image(self):
        ...
        try:
            ...
            #compressed_image = compressed_image[:, :, [2, 1, 0]]
...
if __name__ == '__main__':
    ...
    filename = os.path.join(script_dir, 'position_data.txt') #position_data_cone.txt
