...
namespace RosMessageTypes.UnityMetaQuest
{
    ...
    {
        public const string k_RosMessageName = "unity_meta_quest_msgs/PosRot";
        ...
        public PosRotMsg(float pos_x, float pos_y, float pos_z, float rot_x, float rot_y, float rot_z, float rot_w, string name)
        {
            this.pos_x = pos_x;
            this.pos_y = pos_y;
            this.pos_z = pos_z;
