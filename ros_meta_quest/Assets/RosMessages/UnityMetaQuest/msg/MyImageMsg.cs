...
{
    [Serializable]
    public class MyImageMsg : Message
    {
        public const string k_RosMessageName = "unity_meta_quest_msgs/MyImage";
        ...
        public MyImageMsg(Std.HeaderMsg header, uint height, uint width, string encoding, byte is_bigendian, uint step, byte[] data)
        {
            this.header = header;
            this.height = height;
            this.width = width;
        ...
        public static MyImageMsg Deserialize(MessageDeserializer deserializer) => new MyImageMsg(deserializer);

        private MyImageMsg(MessageDeserializer deserializer)
        {
